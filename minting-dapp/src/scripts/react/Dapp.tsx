    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError(
        <>
          ...
          <br />
          But don't worry! <span className="emoji">😃</span> <strong>we do our best to provide you with the best user experience possible</strong>, even from there.<br />
          <br />
        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              <strong>Hey, Please connect your metamask wallet to Dapp. </strong> <br />
